...
MAC: Signature of encrypted packet
...
1. You: "hey, I want to connect to you and then talk over WebSocket. Here's a challenge to prove you are worthy"
1. Server: "yep yep, let's do it! I completed your challenge."
1. You: Okay, here's a FRAME for message #1
1. Server: Okay great, here a FRAME for MY message #1
1. You: Ok let's close for (reason). Opcode 8!
1. Server: ~closes tcp~
